...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.marketComboBox.setGeometry(QtCore.QRect(49, 10, 141, 21))
        ...
        self.usdHeldValueLabel.setGeometry(QtCore.QRect(230, 60, 61, 20))
        ...
        self.coinsHeldValueLabel.setGeometry(QtCore.QRect(160, 40, 131, 20))
        ...
        self.switchMarketPushButton = QtWidgets.QPushButton(self.centralwidget)
        self.switchMarketPushButton.setGeometry(QtCore.QRect(200, 10, 91, 23))
        self.switchMarketPushButton.setObjectName("switchMarketPushButton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.marketComboBox.setItemText(0, _translate("MainWindow", "GDAX-BTC/USD"))
        self.marketComboBox.setItemText(1, _translate("MainWindow", "GDAX-LTC/USD"))
        self.marketComboBox.setItemText(2, _translate("MainWindow", "GDAX-ETH/USD"))
        ...
        self.switchMarketPushButton.setText(_translate("MainWindow", "Switch Market"))
